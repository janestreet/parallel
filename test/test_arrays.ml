  ...
  module%test Test_bigstring = struct
    ...
    let int_kinds
      ...
      f
        ...
        ~of_int:(fun i ->
          let i0 = Int64_u.of_int64 (bigint_to_int64_trunc i) in
          let i1 = Int64_u.of_int64 (bigint_to_int64_trunc Bigint.(i asr 64)) in
          let i2 = Int64_u.of_int64 (bigint_to_int64_trunc Bigint.(i asr 128)) in
          let i3 = Int64_u.of_int64 (bigint_to_int64_trunc Bigint.(i asr 192)) in
          Int64x4.set i0 i1 i2 i3 |> Int64x4.box)
        ~to_int:(fun a ->
          let #(i0, i1, i2, i3) = Int64x4.splat (Int64x4.unbox a) in
          Bigint.(
            (of_int64_exn (Int64_u.to_int64 i3) lsl 192)
            + (of_int64_exn (Int64_u.to_int64 i2) lsl 128)
            + (of_int64_exn (Int64_u.to_int64 i1) lsl 64)
            + of_int64_exn (Int64_u.to_int64 i0)))
    ;;
    ...
    let%expect_test "iter" =
      ...
      [%expect
        {|
        ("Atomic.get sum"
         14074904626401341155369551180448584754728747257154506489315319115845079122576)
        |}]
    ;;
    ...
    let%expect_test "iteri" =
      ...
      [%expect
        {|
        ("Atomic.get sum"
         14074904626401341155369551180448584754728747257154506489315319115845079123227)
        |}]
    ;;

    let[@tail_mod_cons] rec append p l r =
      match l with
      | [] -> r
      | l :: ll -> l :: append p ll r
    ;;
    ...
    let%expect_test "fold" =
      ...
      [%expect
        ...
        (list (0x1f1e1d1c1b1a191817161514131211100f0e0d0c0b0a09080706050403020100))
        |}]
    ;;
    ...
    let%expect_test "find" =
      ...
      [%expect
        ...
        (option (0x1f1e1d1c1b1a191817161514131211100f0e0d0c0b0a09080706050403020100))
        |}]
    ;;
      ...
      [%expect
        ...
        (bigstring
         ("00000000  07 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          ...
          "000000a0  28 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |(...............|"
          "000000b0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "000000c0  29 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |)...............|"
          "000000d0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "000000e0  2b 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |+...............|"
          "000000f0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000100  40 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |@...............|"
          "00000110  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000120  62 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |b...............|"
      ...
      [%expect
        ...
        (bigstring
         ("00000000  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          ...
          "000000b0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "000000c0  49 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |I...............|"
          "000000d0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "000000e0  60 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |`...............|"
          "000000f0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000100  67 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |g...............|"
          "00000110  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000120  79 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |y...............|"
          "00000130  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"))
        (total 123)
        |}]
    ;;
      ...
      [%expect
        ...
        (bigstring
         ("00000000  0e 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          ...
          "00000020  17 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000030  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000040  26 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |&...............|"
          "00000050  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000060  36 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |6...............|"
          "00000070  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000080  3e 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |>...............|"
          "00000090  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "000000a0  49 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |I...............|"
          "000000b0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "000000c0  60 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |`...............|"
          "000000d0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "000000e0  67 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |g...............|"
          "000000f0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000100  79 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |y...............|"
          "00000110  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000120  7b 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |{...............|"
          "00000130  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"))
        |}]
    ;;
      ...
      [%expect
        ...
        (bigstring
         ("00000000  22 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |\"...............|"
          ...
          "00000050  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000060  21 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |!...............|"
          "00000070  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000080  24 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |$...............|"
          "00000090  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "000000a0  07 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "000000b0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "000000c0  2b 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |+...............|"
          "000000d0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "000000e0  1b 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "000000f0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"))
        |}]
    ;;
      ...
      [%expect
        ...
        (bigstring
         ("00000000  24 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |$...............|"
          ...
          "00000030  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000040  2b 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |+...............|"
          "00000050  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000060  1b 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"
          "00000070  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|"))
        |}]
    ;;
  end
